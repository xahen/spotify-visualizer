            ...
            <div className="m-auto">
                ...
                <div className="mt-2">
                    <h2 className="text-2xl italic">
                        This site allows you to graphically visualize your
                        Spotify data.
                    </h2>
                </div>
                ...
                <div className="mt-4">
                    ...
                    <ul className="text-base list-disc ml-8">
                        ...
                        <li>
                            See the songs you&apos;ve historically skipped the
                            most.
                        </li>
                    </ul>
                </div>
                ...
                <div className="mt-8">
                    ...
                    <div className="mt-2 ml-4">
                        ...
                        <p>
                            Upload the &apos;.zip&apos; files that you
                            downloaded from Spotify to this website.
                        </p>
                        <p>
                    ...
                    <div className="mt-2 ml-4">
                        ...
                        <p>
                            Enjoy going through a beautiful and nostalgic trip
